...
# i = IP(src="192.168.0.3", dst="192.168.0.4")
# u = UDP(sport=48664, dport=30509)
# sip = SOMEIP()
# sip.iface_ver = 0
# sip.proto_ver = 1
...
#### Required for version 2.4.5 using python 3.7.6, pip3 ####
load_contrib("automotive.someip")

i = IP(src="192.168.0.19", dst="192.168.0.18")
u = UDP(sport=46334, dport=30509)
sip = SOMEIP()
sip.iface_ver = 0
sip.proto_ver = 1
sip.msg_type = "REQUEST"
...
sip.add_payload(Raw ("ping"))
p = i/u/sip
res = sr1(p, retry=0, timeout=1, verbose=False)
